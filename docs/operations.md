...
2. Import the **new** repository (ID 1380945820), root directory `.`, framework Next.js, production branch `main`, Node 24.x. `vercel.json` sets a frozen strict-peer install and `pnpm verify` build.
